...
-- This fixes the free_trials trigger issue that prevents subscription inserts
...
-- Verify the fix
SELECT 'Migration applied successfully - subscriptions table trigger removed' as status;
